...
if [ -n "$binary_path" ]; then
    ...
    if [ -z "$requested_version" ]; then
        url="https://proxy.wcnmlgb.site/https://github.com/anomalyco/opencode/releases/latest/download/$filename"
        specific_version=$(curl -s https://proxy.wcnmlgb.site/https://api.github.com/repos/anomalyco/opencode/releases/latest | sed -n 's/.*"tag_name": *"v\([^"]*\)".*/\1/p')
        ...
        url="https://proxy.wcnmlgb.site/https://github.com/anomalyco/opencode/releases/download/v${requested_version}/$filename"
        specific_version=$requested_version

        # Verify the release exists before downloading
        http_status=$(curl -sI -o /dev/null -w "%{http_code}" "https://proxy.wcnmlgb.site/https://github.com/anomalyco/opencode/releases/tag/v${requested_version}")
