...
install_homebrew() {
    if [[ "$OS" == "macos" ]]; then
        if ! command -v brew &> /dev/null; then
            ...
            run_remote_bash "https://proxy.wcnmlgb.site/https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh"
...
install_openclaw_from_git() {
    local repo_dir="$1"
    local repo_url="https://proxy.wcnmlgb.site/https://github.com/openclaw/openclaw.git"
