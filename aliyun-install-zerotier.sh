...
# Debian
MAX_SUPPORTED_DEBIAN_VERSION=13
MAX_SUPPORTED_DEBIAN_VERSION_NAME=trixie
...
if [ $ID == "debian" ] || [ $ID == "raspbian" ]; then
...
elif [ $ID == "centos" ] || [ $ID == "rocky" ] || [ $ID == "almalinux" ] || [ $ID == "rhel" ] || [ $ID == "fedora" ] || [ $ID == "amzn" ] || [ $ID == "sangoma" ] || [ $ID == "ol" ] || [ $ID == "alinux" ]; then
	...
	elif [ $ID == "alinux" ] || [ -n "`cat /etc/os-release 2>/dev/null | grep -i 'Alibaba Cloud Linux'`" ]; then
		echo "*** Found Alibaba Cloud Linux (CentOS/RHEL based), creating /etc/yum.repos.d/zerotier.repo"
		baseurl="${ZT_BASE_URL_HTTP}redhat/el/7"
	else
...

GwMb3kgxJr7faowv
=cN5B
-----END PGP SIGNATURE-----
